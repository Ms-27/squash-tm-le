...
RUN wget http://repo.squashtest.org/distribution/squash-tm-${SQUASH_VERSION}.RELEASE.tar.gz && tar xvf squash-tm-${SQUASH_VERSION}.RELEASE.tar.gz && \
rm squash-tm-${SQUASH_VERSION}.RELEASE.tar.gz
